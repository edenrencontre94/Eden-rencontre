      ...
      <div className={`relative ${size === "sm" ? "aspect-[3/4]" : "aspect-[4/5]"} overflow-hidden`}>
        ...
        <div className="absolute top-2 left-2 right-2 flex items-start justify-between gap-2">
          <div className="flex flex-col gap-1">
            ...
            {profile.premium && (
              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full bg-gradient-to-r from-[hsl(var(--gold))] to-[hsl(var(--gold-light))] text-[10px] font-semibold text-[hsl(var(--gold-foreground))] shadow-soft">
