...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "Eden Rencontre" },
      ...
      { title: "Eden Rencontre  , Là où la foi unit les cœurs" },
      { name: "description", content: "Eden Rencontre, la plateforme №1 de rencontres sérieuses chrétiennes. Rencontrez votre futur conjoint dans un espace sécurisé, centré sur la foi et le mariage." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Eden Rencontre  , Là où la foi unit les cœurs" },
      { property: "og:description", content: "Eden Rencontre, la plateforme №1 de rencontres sérieuses chrétiennes. Rencontrez votre futur conjoint dans un espace sécurisé, centré sur la foi et le mariage." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Eden Rencontre  , Là où la foi unit les cœurs" },
      { name: "twitter:description", content: "Eden Rencontre, la plateforme №1 de rencontres sérieuses chrétiennes. Rencontrez votre futur conjoint dans un espace sécurisé, centré sur la foi et le mariage." },
