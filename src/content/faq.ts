...
export const FAQ: FaqItem[] = [
  // â”€â”€ Découvrir la plateforme â”€â”€
  {
    category: "Découvrir Eden Rencontre",
    q: "Qu'est-ce qu'Eden Rencontre ?",
    a: "Eden Rencontre est une plateforme de rencontres réservée aux chrétiens qui cherchent une relation sérieuse orientée vers le mariage. Elle réunit des célibataires d'Afrique francophone et de la diaspora autour d'une même conviction : un couple se bâtit sur une foi partagée.",
  },
  {
    category: "Découvrir Eden Rencontre",
    q: "L'inscription est-elle vraiment gratuite ?",
    a: "Oui. Créer un profil, découvrir des membres, envoyer des likes et échanger avec vos matchs ne coûte rien. La formule Gratuite comporte des limites quotidiennes – 25 likes, 5 messages et un Super Like par semaine – que la formule Premium lève.",
  },
  {
    category: "Découvrir Eden Rencontre",
  ...
  // â”€â”€ Fonctionnement â”€â”€
  {
    category: "Comment ça marche",
    q: "Comment se crée un match ?",
    a: "Lorsque deux membres se likent mutuellement, un match se crée et la conversation s'ouvre. Personne ne peut vous écrire sans que l'intérêt soit réciproque, à l'exception d'un message d'introduction réservé aux membres Premium.",
  },
  {
    category: "Comment ça marche",
    q: "Qu'est-ce qu'un Super Like ?",
    a: "Le Super Like signale un intérêt particulier : la personne le voit immédiatement, avant même de découvrir votre profil dans son fil. En formule Gratuite vous en disposez d'un par semaine, contre cinq par jour en Premium.",
  },
  {
    category: "Comment ça marche",
    q: "À quoi sert le Boost ?",
    a: "Un Boost place votre profil en tête des découvertes pendant une durée déterminée, ce qui multiplie le nombre de personnes qui le voient. La formule Premium en inclut de un à quatre par mois selon la durée souscrite, et des Boosts de 24 heures, 3 jours ou 7 jours peuvent s'acheter séparément.",
  },
  {
    category: "Comment ça marche",
    q: "Puis-je masquer mon profil ?",
    a: "Oui. Trois réglages existent : visible par tous, visible uniquement des personnes que vous avez likées, ou entièrement en pause. Ce réglage fait partie de la formule Premium.",
  },

  // â”€â”€ Sécurité et confiance â”€â”€
  {
    category: "Sécurité et confiance",
    q: "Les profils sont-ils vérifiés ?",
    a: "Les profils vérifiés portent un badge visible. La vérification d'identité et de foi est traitée en priorité pour les membres Premium. Vous pouvez par ailleurs signaler ou bloquer n'importe quel membre en deux clics, et chaque signalement est examiné.",
  },
  {
    category: "Sécurité et confiance",
  ...
  // â”€â”€ Abonnement et paiement â”€â”€
  {
